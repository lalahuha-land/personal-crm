...
function App() {
  ...
  const handleSaveReminder = (reminder: { contactId: string; contactName: string; message: string; date: Date; completed?: boolean }) => {
      ...
      case 'home':
        return (
          <Home
            ...
            onNewReminder={() => setIsReminderEntryOpen(true)}
          />
        );
      case 'contacts':
        return (

...
const Home: React.FC<HomeProps> = ({ contacts, reminders, onContactClick, onReminderComplete, onNewReminder }) => {
        ...
        <div className="bg-white/50 dark:bg-gray-900/50 backdrop-blur-sm border border-gray-200 dark:border-gray-800 rounded-2xl p-6">
          <div className="flex items-center space-x-2 mb-6">
            ...
            <button
              ...
              className="ml-auto flex items-center space-x-2 bg-sage-600 hover:bg-sage-700 text-white px-4 py-2 rounded-full transition-all duration-200 hover:scale-105 hover:shadow-lg hover:shadow-sage-600/25 text-sm"
            >
              + Add Reminder
            </button>
          </div>
